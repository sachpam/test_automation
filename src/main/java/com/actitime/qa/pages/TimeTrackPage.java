...
public class TimeTrackPage extends TestBase {
    ...
    @FindBy(css = "#approveTTTable .childRow.notReady")
    WebElement notReadyRow;
    ...
    public TimeTrackPage clickNotReadyCheckbox() {
        WebElement chkbox = notReadyRow.findElement(By.cssSelector("input[type=checkbox]"));
        chkbox.click();
        return new TimeTrackPage();
    }

    public void clickApproveReady() {
        approveButton.click();
        driver.findElement(By.cssSelector("#approveTTTable .childRow.operationWasApplied.approved"));
    }

    public void clickRejectReady() {
        rejectButton.click();
    ...
    //for not-ready row
    public void clickApproveNotReady() {
        approveButton.click();
        driver.findElement(By.cssSelector("#approveTTTable .childRow.operationWasApplied.approved"));
    }

    public void clickRejectNotReady() {
        rejectButton.click();
        rejectInput.sendKeys("Type Reject reason");
        rejectInputButton.click();
        driver.findElement(By.cssSelector("#approveTTTable .childRow.operationWasApplied.rejected"));
